...
// Frontend visibility list: show only Karnataka in UI.
// Backend data and APIs can still retain all states.
export const FRONTEND_STATES: State[] = INDIA_STATES.filter((s) => s.slug === "karnataka");
