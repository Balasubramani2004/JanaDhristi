  ...
  return (
    ...
    >
      ...
      <ol style={{ paddingLeft: 18, margin: 0 }}>
        ...
        <li style={{ marginBottom: 8 }}><strong>Not an official government service.</strong> JanaDhristi is an independent civic platform. For binding status, always verify on the source portal.</li>
        ...
        <li style={{ marginBottom: 8 }}><strong>Takedown & grievance.</strong> 7-working-day SLA. Email <a href="mailto:support@janadhristi.in?subject=Takedown%20Request%3A%20Tenders%20module" style={{ color: "#2563EB", textDecoration: "underline" }}>support@janadhristi.in</a> with subject line &ldquo;Takedown Request&rdquo;. Winning bidders may request 7-year anonymisation for individual records.</li>
