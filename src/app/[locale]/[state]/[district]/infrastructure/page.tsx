  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: 12, color: "#78350F", lineHeight: 1.55 }}>
        ...
        articles and government press releases. JanaDhristi does not independently
  ...
  return (
    <div style={{ padding: "14px 16px", background: "#FAFAFE", border: "1px solid #E0E7FF", borderLeft: "4px solid #7C3AED", borderRadius: 12 }}>
      ...
      <div style={{ marginTop: 8, fontSize: 10, color: "#9B9B9B" }}>
        Source: {data.sources} news articles · Generated by Gemini 2.5 Pro · JanaDhristi
      </div>
    </div>
  );
}
    ...
    >
      ...
      {hasCourtMention(p) && (
        <div
          ...
          title="This project is referenced in court proceedings. JanaDhristi reports the fact, not a judgment on the matter."
        >
...
function LegalFooter() {
  return (
    ...
    >
      ...
      Infrastructure project data on JanaDhristi is compiled from publicly available news articles and government
      ...
      and public interest.
      <br /><br />
      For verified project information, contact the relevant executing agency directly. JanaDhristi is an
