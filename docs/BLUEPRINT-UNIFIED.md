...
#     → writes judge-ready files under judge-kit/krishi-ai/datasets
#   • Added transparent demo trainer:
#     judge-kit/krishi-ai/train-demo-model.ts
#     → generates model artifact with weights + accuracy
#   • Added showcase docs:
#     docs/KRISHI-AI-SHOWCASE.md + judge-kit/krishi-ai/README.md
#   • Added explicit feature mapping artifact:
#     judge-kit/krishi-ai/datasets/feature-mapping.json (generated by export script)
#
